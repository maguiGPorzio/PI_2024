...
Dicha función debe devolver el valor 0 si hay igual cantidad de paréntesis que abren y que cierran, y  retorna un valor distinto de cero en 
caso contrario. No definir variables ni funciones auxiliares. 
*/
