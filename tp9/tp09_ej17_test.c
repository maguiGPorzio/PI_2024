...
Cada palabra debería tener entre 0 y 9 caracteres, por lo que después de cada palabra hay un carácter indicando la longitud de la
misma ('4' si tiene 4 letras, '8' si tiene 8 letras, etc.).
Escribir una función recursiva bienFormado que reciba como único argumento un string con el formato mencionado y retorne 0 (cero)
si está bien formado, y distinto de cero si no.
