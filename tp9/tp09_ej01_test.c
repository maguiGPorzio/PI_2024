...
/*
Escribir una función recursiva que reciba como parámetros de entrada un vector de enteros y su dimensión, y que devuelva 
en su nombre la suma de todos sus elementos.
*/

int 
sumaVec(const int *vector, unsigned int dim){
  if (dim==0){
    return 0;
  }
