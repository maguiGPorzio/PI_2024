...
un nuevo string con los primeros n caracteres del string s. Si la longitud de s es menor a n debe retornar una
copia de s. En caso de que no se pueda copiar debe retornar NULL. ¿Qué cuidado debe tener el usuario de
esta función?
*/
...
//DEBE DE TENER CUIDADO QUE DSP EL STRING NO SE PUEDE MODIFICAR
