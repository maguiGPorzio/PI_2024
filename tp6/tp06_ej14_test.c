...
int elemEnVec (const int v1[], unsigned int dim1, const int v2[], unsigned int dim2);
...
contiene(const int v1[], unsigned int dim1, const int v2[], unsigned int dim2){
  if (elemEnVec(v1,dim1,v2,dim2)){
    return 1;
  }
  if (elemEnVec(v2,dim2,v1,dim1)){
    return 2;
  }
  return 0;
}
...
int
elemEnVec (const int v1[], unsigned int dim1, const int v2[], unsigned int dim2){
  int esta=1;
  for (int i=0 ; i<dim1 && esta; i++){
    esta=0;
