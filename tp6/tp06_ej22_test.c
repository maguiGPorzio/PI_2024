...
comienzo: Dónde comienza la secuencia de números ordenados en forma ascendente (cada elemento debe 
ser mayor al anterior) de mayor longitud
longitud: Longitud de esa secuencia

En caso de haber más de una secuencia con la mayor longitud debe almacenar en comienzo donde comienza 
la primera de ellas.
