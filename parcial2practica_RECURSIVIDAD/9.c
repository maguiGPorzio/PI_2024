...
donde la marca de final es un número negativo. La función debe retornar cero si los elementos del vector están "apareados por sumas", y 
distinto de cero si no, de acuerdo a los siguientes ejemplos:
*/
