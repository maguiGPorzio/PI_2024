/*
Escribir una función recursiva que dada una lista de enteros que debería estar ordenada en forma
ascendente, elimine de la misma los elementos que no cumplan con ese orden.
