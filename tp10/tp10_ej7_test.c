...
/*
Escribir una función recursiva listIntersec que reciba como únicos parámetros dos listas ordenadas ascendentemente y 
retorne una nueva lista con la intersección de ambas. 
*/

TList 
listIntersec  (const TList list1, const TList list2){
